...
let getCityWeather = function(city) {
    ...
    let apiUrl = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=39a3ce7b7009295c100a503969c856c0&units=imperial";
...
let displayWeather = function(weatherData) {
    ...
    fetch("https://api.openweathermap.org/data/2.5/uvi?lat=" + weatherData.coord.lat + "&lon="+ weatherData.coord.lon + "&appid=39a3ce7b7009295c100a503969c856c0")
        .then(function(response) {
            response.json().then(function(data) {
    ...
    // five-day api call
    fetch("https://api.openweathermap.org/data/2.5/forecast?q=" + weatherData.name + "&appid=39a3ce7b7009295c100a503969c856c0&units=imperial")
        .then(function(response) {
            response.json().then(function(data) {
                ...
                for(i = 7; i <= data.list.length; i += 8){
                    ...
                    let fiveDayCard =`
                    <div class="shadow-lg col-md-2 m-2 py-3 card text-white bg-secondary">
